<template>
	<DataTable v-model:filters="filters" :value="products" paginator :rows="10" :rowsPerPageOptions="[5, 10, 20, 50]" tableStyle="min-width: 50rem" dataKey="id" filterDisplay="row" :loading="loading" :globalFilterFields="['name', 'code', 'price']" class="border-round-sm">
	    <template #header>
...
<script setup>
	...
	const loading = ref(true),
			...
			columns = [
				...
				{ field: 'netdesposit', header: 'Net Deposit' }*/
			]
			// products = ref([])
