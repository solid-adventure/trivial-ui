<template>
	<h2 class="mb-1 font-semibold">Dashboard</h2>
...
<script setup>
	import ChartsPanel from '@/components/organization-settings/dashboard/charts/ChartsPanel.vue'
	import summary_group from '@/components/organization-settings/dashboard/summary-group-settings/ActualsPanel.vue'
	import table from '@/components/organization-settings/dashboard/table-settings/GrossRevenuePanel.vue'
