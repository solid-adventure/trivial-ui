<template>
	<DataTable :value="keys" tableStyle="max-width: 100%" class="apikeys__table">
		<template #header>
			<div class="flex justify-content-between py-5">
				...
				<Button label="Add New Key" icon="pi pi-plus" @click="emit('openAddKeyModal')" class="apikeys__table__add--btn" />
			</div>
		</template>
