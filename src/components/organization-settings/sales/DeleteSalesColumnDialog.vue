<template>
	<Dialog v-model:visible="visible" modal @hide="closeModal" header="Delete Column" class="org-settings__dialog">
		...
		<p class="mt-1">Are you sure you want to proceed with deleting column <strong class="capitalize">{{ deletedCol.name }}</strong>? By deleting this column, it will be removed from the existing table on Sales page.</p>
