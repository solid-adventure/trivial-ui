	...
	<header class="main__header">
		<div class="main__header__top">
			...
			<div class="main__header__top__content">
				...
				<Button type="button" icon="pi pi-user" @click="toggleMenu" aria-haspopup="true" aria-controls="overlay_menu" severity="secondary" aria-label="User" />

				<ToggleButton v-model="checkedTheme" @click="toggleDark()" v-ripple onLabel="" offLabel="" onIcon="pi pi-sun" offIcon="pi pi-moon" class="w-2.5rem" aria-label="Do you confirm" />
