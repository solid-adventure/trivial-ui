...
<script setup>
  ...
  onMounted(() => {
	...
	const getDataOptions = computed(() => {
      ...
      // NOTE We don't currently pass the filters to the API, but just apply them to the result.
      //      It's plausible that will change, and if it does, we'll need to append the nonEditableSearch
      //      to any search generated by the filters
