<template>
	<Panel header="Forecast" :pt="{root: {class: 'max-w-max shadow-2'}, header: {class: 'text-lg'}}">
		<div class="flex flex-wrap1 gap-5">
			<div v-for="(item, index) in selected" :key="index" class="pr-5 border-300" :class="{'border-right-1': index !== lastItem}">
