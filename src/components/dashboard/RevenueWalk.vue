<template>
	<Panel class="shadow-2">
		<DataTable :value="revenueWalk" scrollable rowGroupMode="rowspan" groupRowsBy="revenueType" tableStyle="min-width: 120rem" class="revenue__gross__table">
			<template #header>
...
<script setup>
	...
	const props = defineProps(['revenueWalk'])
