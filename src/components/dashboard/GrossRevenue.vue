<template>
	<Panel class="shadow-2">
		<DataTable :value="grossRevenue" scrollable rowGroupMode="rowspan" groupRowsBy="customerType" tableStyle="min-width: 120rem" class="revenue__gross__table">
			<template #header>
...
<script setup>
	...
	const props = defineProps(['grossRevenue'])
