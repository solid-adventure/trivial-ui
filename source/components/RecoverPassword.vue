<template>
    <div class="overlay">
        <div class="container">
            ...
            <p>Enter the email associated with your Trivial account and we'll send you a link to reset your password.</p>
            <form id='resetPasswordForm'>
                ...
                <ActionButton class = "button-small submit" :action="handleSubmit" value ="Submit" working-value="Creating..."></ActionButton>
	        </form>
	        <span class="register">New to Trivial? <a href="/register">Sign Up</a></span><br>
